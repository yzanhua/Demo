...
hid_t write_to_file(hid_t fid, int rank, int np, const char* dset_name) {
  herr_t err = 0;
  int nerrs = 0;
  ...
  did = H5Dcreate(fid, dset_name, H5T_STD_I32LE, filespace_id, H5P_DEFAULT,
